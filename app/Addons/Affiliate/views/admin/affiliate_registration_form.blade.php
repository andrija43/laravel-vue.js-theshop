...
@section('content')
	...
	<div class="col-sm-12">
		...
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('affiliate.update_registration_form') }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="row">
								...
								@elseif ($element->type == 'select' || $element->type == 'multi_select' || $element->type == 'radio')
									<div class="form-group row" style="background:rgba(0,0,0,0.1);padding:10px 0;">
									    ...
									    <div class="col-lg-7">
									        ...
									        <button class="btn btn-primary pull-right" type="button" onclick="add_customer_choice_options(this)"><i class="glyphicon glyphicon-plus"></i> Add option</button>
									    </div>
									    <div class="col-lg-2"><span class="btn btn-icon btn-circle" onclick="delete_choice_clearfix(this)"><i class="las la-times"></i></span></div>
									</div>
								@endif
