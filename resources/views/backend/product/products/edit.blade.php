    ...
    <script>
        $(document).ready(function() {
            ...
            for (let i = 0; i < myArray.length; i++) {
                ...
                $('#treeview input:checkbox#'+element).closest( "ul" ).css( "display", "block" );
                $('#treeview input:checkbox#'+element).closest( "ul" ).parent( "li" ).find('.las').removeClass( "la-plus" ).addClass('la-minus');
            }
